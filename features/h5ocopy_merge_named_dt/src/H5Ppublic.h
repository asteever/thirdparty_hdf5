...
H5_DLL herr_t H5Padd_merge_named_dtype_path(hid_t plist_id, const char *path);
H5_DLL herr_t H5Pfree_merge_named_dtype_paths(hid_t plist_id);
H5_DLL herr_t H5Pset_mndt_search_cb(hid_t plist_id, H5O_mndt_search_cb_t func, void *op_data);
H5_DLL herr_t H5Pget_mndt_search_cb(hid_t plist_id, H5O_mndt_search_cb_t *func, void **op_data);
