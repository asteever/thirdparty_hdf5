...
**  A. ssize_t Attribute::getName(size_t buf_size, char* attr_name),
...
**
**  B. ssize_t Attribute::getName(size_t buf_size, H5std_string& attr_name)
**	With buffer smaller than the actual name
**
**  C. H5std_string Attribute::getName()
**
**  D. H5std_string Attribute::getName(size_t buf_size)
**	With buffer size equals the name's length
**
****************************************************************/
static void test_attr_getname()
{
	...
	// ssize_t Attribute::getName(size_t buf_size, char* attr_name),
	...
	name_size = fattr1.getName(buf_size+1, fattr1_name);
