...
#define H5Z_DIRECT_IO_NAME      "direct_io"  /* for direct IO information */
...
H5_DLL herr_t H5Z_pipeline(const struct H5O_pline_t *pline,
			    ...
			    size_t *nbytes/*in,out*/, size_t *buf_size/*in,out*/,
                            void **buf/*in,out*/, hid_t plist_id);
...
H5_DLL ssize_t H5Z_alloc (void **buffer, size_t size, hbool_t initialize, hid_t papl_id);
H5_DLL herr_t  H5Z_free(void *mem);
