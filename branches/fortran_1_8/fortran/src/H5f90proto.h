...
H5_FCDLL int_f nh5dset_extent_c(hid_t_f *dset_id, hsize_t_f *size); /*MSB*/
...
H5_FCDLL int_f nh5pset_create_intermediate_group_c(hid_t_f *lcpl_id, int_f *crt_intermed_group); /* MSB */
