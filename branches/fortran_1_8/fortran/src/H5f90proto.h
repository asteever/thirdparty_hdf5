...
#   define nh5pset_create_inter_gr_c H5_FC_FUNC_(h5pset_create_inter_gr_c,H5PSET_CREATE_INTER_GR_C) /* MSB */
...
H5_FCDLL int_f nh5pset_create_inter_gr_c(hid_t_f *lcpl_id, int_f *crt_intermed_group); /* MSB */
