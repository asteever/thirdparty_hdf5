...
/* Method to construct single element projection */
typedef herr_t (*H5S_sel_project_single)(const H5S_t *space, hsize_t *offset);
...
typedef struct {
    ...
    H5S_sel_project_single project_single;      /* Method to construct single element projection */
